namespace AutomatedCarTests.Models
{
    ...
    {
        [Theory]
        [InlineData(10,10,"parking",false, 1,0,0,1)]
        public void CreateParkingTest(int x, int y, string filename,bool iscolliding,  double n11, double n12, double n21, double n22)
        {
            ...
            var parking1 = new Parking(x, y, filename,iscolliding, rotmat,poligons);
